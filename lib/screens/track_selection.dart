              ...
              children: [
                ...
                ActionButton(
                    ...
                    onPressed: () async {
                      ...
                      for (int cupIndex = 0; cupIndex < raceSelections.cups.length; cupIndex++) {
                        for (int trackIndex = 0; trackIndex < raceSelections.cups[cupIndex].tracks.length; trackIndex++) {
                          if (raceSelections.cups[cupIndex].tracks[trackIndex].selected) {
                      ...
                      if (raceList.isEmpty || raceList.length == 1) {
                        proceed = await showDialog(
                          ...
                          builder: (context) => AlertPopup(
                            contentText: raceList.isEmpty ? 'No tracks, no race!' : 'Can\'t shuffle, no race!',
                            buttonOnPressed1: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => RacesSelected(
                            finalRaceList: shortRaceList.sublist(0, raceCountSelected),
                          ),
                        ),
                      );
                    }),
